          ...
          <form onSubmit={handleBlockDate} className="ss-date-row">
            ...
            <div className="ss-input-group" style={{ marginBottom: 0 }}>
              ...
              <input
                ...
                min={
                  dateForm.startDate || new Date().toISOString().split("T")[0]
                }
                required
                disabled={isAddingBlock}
              />
            ...
            <div className="ss-input-group" style={{ marginBottom: 0 }}>
              ...
              <input
                ...
                onChange={(e) =>
                  setDateForm({ ...dateForm, reason: e.target.value })
                }
                disabled={isAddingBlock}
              />
            </div>
            ...
            <table className="ss-table">
              <thead className="ss-thead">
                <tr>
                  ...
                  <th className="ss-th" style={{ textAlign: "right" }}>
                    Action
                  </th>
                </tr>
              </thead>
                ...
                {loading ? (
                  ...
                  <tr>
                    <td colSpan="4" className="ss-empty-state">
                      ...
                      />{" "}
                      No active restrictions. Booking is open.
                    </td>
                  </tr>
                ) : (
                  blockedPeriods.map((period) => (
                    <tr key={period.id} className="ss-tr">
                      <td className="ss-td">
                        <span className="ss-date-badge">
                          {period.startDate}
                        </span>
                      </td>
                      <td className="ss-td">
                        <span className="ss-date-badge">{period.endDate}</span>
                      </td>
                      <td
                        className="ss-td"
