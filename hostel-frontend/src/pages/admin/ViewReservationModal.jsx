    ...
    <div className="mr-overlay" onClick={onClose}>
      ...
      >
        {isLoading ? (
          ...
          <>
            <div className="mr-modal-header">
              <div>
                ...
                <div style={{ marginTop: "5px" }}>
                  <span
                    className={`mr-badge ${getStatusBadgeClass(reservation.status)}`}
                  >
                    {reservation.status}
                  </span>
                </div>
            ...
            <div className="mr-modal-body">
              ...
              <div className="mr-detail-row">
                ...
                <span className="mr-detail-value">
                  {reservation.studentRegistrationNumber}
                </span>
              </div>
              <div className="mr-detail-row">
              ...
              <div className="mr-section-title" style={{ marginTop: "25px" }}>
                <Building2 size={16} /> Accommodation
              </div>
              <div className="mr-detail-row">
                <span className="mr-detail-label">Room / Bed</span>
                <span className="mr-detail-value">
                  {reservation.roomNumber} - {reservation.bedNumber}
                </span>
              </div>
              <div className="mr-detail-row">
                <span className="mr-detail-label">Duration</span>
                <span className="mr-detail-value">
              ...
              <div className="mr-section-title" style={{ marginTop: "25px" }}>
                <Receipt size={16} /> Payment Information
              </div>
              <div className="mr-detail-row">
                <span className="mr-detail-label">Amount</span>
                <span className="mr-detail-value" style={{ color: "#15803d" }}>
                  LKR {reservation.amountPaid}
                </span>
              </div>
              <div className="mr-detail-row">
                <span className="mr-detail-label">Status</span>
                <span className="mr-detail-value">
                  <span
                    className={`mr-payment-badge ${getPaymentBadgeClass(reservation.paymentStatus)}`}
                  >
          ...
          <div className="mr-loading" style={{ color: "red" }}>
            Failed to load data.
          </div>
        )}
      </div>
