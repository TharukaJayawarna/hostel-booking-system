...
import { 
  Phone, Mail, MapPin, Clock, MessageSquare, Facebook, Twitter, 
  Linkedin, ChevronDown, ChevronUp, HelpCircle, ShieldAlert
} from 'lucide-react';
    ...
    <div className="contact-container">
      <div className="contact-inner">
        ...
        <div className="contact-header">
            <div className="contact-badge"><MessageSquare size={14}/> Support Center</div>
            <h1 className="contact-title">Contact Administration</h1>
            <p className="contact-subtitle">
                Have questions or need assistance? Reach out to us directly through the channels below.
            </p>
        </div>
            ...
            <div className="contact-left-col">
                ...
                <div className="contact-cards-grid">
                    <div className="contact-info-card">
                        <div className="contact-icon-box icon-blue"><MapPin size={22}/></div>
                        <div className="contact-card-content">
                            <div className="contact-card-label">Visit Us</div>
                            <div className="contact-card-value">
                                NSBM Green University,<br/>Pitipana, Homagama
                            </div>
                        </div>
                    </div>

                    <div className="contact-info-card">
                        <div className="contact-icon-box icon-green"><Phone size={22}/></div>
                        <div className="contact-card-content">
                    ...
                    <div className="contact-info-card">
                        <div className="contact-icon-box icon-orange"><Mail size={22}/></div>
                        <div className="contact-card-content">
                    ...
                    <div className="contact-info-card">
                        <div className="contact-icon-box icon-purple"><Clock size={22}/></div>
                        <div className="contact-card-content">
                            <div className="contact-card-label">Hours</div>
                            <div className="contact-card-value">
                                Weekdays: 8:30 - 5:00<br/>
                                Weekends: 9:00 - 1:00
                            </div>
                        </div>
                    </div>
                ...
                <div className="contact-social-section">
                    ...
                    <div className="contact-social-row">
                        <button className="contact-social-btn fb"><Facebook size={18}/></button>
                        <button className="contact-social-btn tw"><Twitter size={18}/></button>
                        <button className="contact-social-btn ln"><Linkedin size={18}/></button>
                    </div>
                </div>
            </div>

            {/* RIGHT COLUMN: FAQ & Emergency ONLY */}
            <div className="contact-right-col">
                
                {/* Emergency Box (Moved to Top for Visibility) */}
                ...
                <div className="contact-faq-container">
                    <div className="contact-faq-header">
                        ...
                        <span className="contact-faq-title">Frequently Asked Questions</span>
                    </div>
                    
                    <div className="contact-faq-list">
                        {faqs.map((faq, index) => (
                            <div key={index} className={`contact-faq-item ${openFaq === index ? 'open' : ''}`}>
                                <button 
                                    className="contact-question-box" 
                                    onClick={() => toggleFaq(index)}
                                    aria-expanded={openFaq === index}
                                >
                                    <span className="contact-question-text">{faq.question}</span>
                                    {openFaq === index ? <ChevronUp size={16} color="#4f46e5"/> : <ChevronDown size={16} color="#94a3b8"/>}
                                </button>
                                <div className={`contact-answer-box ${openFaq === index ? 'show' : ''}`}>
                                    {faq.answer}
                                </div>
                            </div>
                        ))}
